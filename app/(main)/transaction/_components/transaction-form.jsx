...
export function AddTransactionForm({
    ...
    defaultValues:
      editMode && initialData
        ? {
            ...
            amount: convertAmount(initialData.amount).toFixed(2),
  ...
  const onSubmit = async (data) => {
    ...
    const baseAmount = convertAmount(parseFloat(data.amount), true);
    ...
    if (editMode) {
      transactionFn(editId, submissionData);
    } else {
      transactionFn(submissionData);
    }
  };
